...
import (
	...
	"bor-bc-go/x/borservice"
)

const appName = "borservice"

var (
	// default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.borcli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.bord")
...
func NewNameServiceApp(
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, params.StoreKey, borservice.StoreKey)
	...
	app.borKeeper = borservice.NewKeeper(
		app.bankKeeper,
		keys[borservice.StoreKey],
		app.cdc,
	)
	...
	app.mm = module.NewManager(
		...
		borservice.NewAppModule(app.borKeeper, app.bankKeeper),
